                ...
                for j in range(1, 31):
                    if j < 10:
                        ...
                        if photo:
                            ...
                            break
                    if 9 < j < 22:
                        photo_2 = requests.get('https://www.gexing.com/qqtouxiang/{}_2.html'.format(number),headers=headers())
                        ...
                        photo_3 = requests.get('https://www.gexing.com/qqtouxiang/{}_3.html'.format(number),headers=headers())
